...
dotplots(file = "data/seq3.xlsx",output.file = "results/dotplots_complete.xlsx",gap.marker = "GP", sep = F, colors = c("#ffa666","#ffd966", "#00BFFF")) 
...
sw(file = "data/seq3.xlsx",output.file = "results/sw_incl_rev.xlsx", gap.marker = "GP",rev = T, sec_order = F)
