###Installation und laden der notwendigen R-Pakete falls noch nicht installiert
packages = c("ggplot2", "reshape", "openxlsx", "stringr")
## 
...
##Input File mit Spalten, die die Sequenzen enthalten, einlesen
#(falls Probleme mit dem Einlesen auftreten wähle unter Session --> Set Working directory das directory, in dem die Daten liegen.)
###oder ändern zum vollen Pfad, wenn Skript nicht im selben Ordner liegt wie die Daten
...
dotplots(file = "seq3.xlsx",output.file = "functiontest_complete.xlsx",sep = F)
